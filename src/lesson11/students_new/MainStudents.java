/*
Поиск группы с наименьшим средним баллом и вывод список ее студентов.
Заполнение групп - Random метод.
...
public class MainStudents {
    public static void main(String[] args) {
        ...
        int kick = Student.minInArray(forAvg);
